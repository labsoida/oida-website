...
# KPI del marketing sanitario: come misurare quello che conta davvero
...
1. [Metriche di piattaforma vs metriche di business](#metriche-di-piattaforma-vs-metriche-di-business)
2. [Il funnel completo: dove si misura davvero la performance](#il-funnel-completo-dove-si-misura-davvero-la-performance)
3. [I KPI fondamentali per una struttura sanitaria privata](#i-kpi-fondamentali-per-una-struttura-sanitaria-privata)
4. [Come costruire un sistema di reporting che funziona](#come-costruire-un-sistema-di-reporting-che-funziona)
5. [KPI per specialità: perché i benchmark cambiano](#kpi-per-specialita-perche-i-benchmark-cambiano)
6. [FAQ](#faq)
...
Il collegamento tra CPL e CAC, con un caso reale numerico, è analizzato nell'articolo su [CPL e CAC nel marketing sanitario](/blog/cpl-cac-marketing-sanitario-metrica-redditivita/).
...
Senza un CRM, la raccolta è manuale ma possibile: un foglio di tracciamento dei contatti in entrata con data, canale di provenienza e esito (appuntamento fissato, no-show, visita erogata) permette di ricostruire il funnel anche in modo semplice. Non è ottimale ma è infinitamente meglio di non avere dati.

**Cosa fare se il CAC calcolato supera la marginalità della singola visita?**

Un CAC superiore al margine della prima visita non è necessariamente un problema se l'LTV del paziente nel tempo è significativamente superiore al CAC. In specialità ricorrenti, è normale e accettabile acquisire un paziente a un costo superiore alla prima visita se si prevede di trattenerlo per più anni. Il problema si presenta quando il CAC supera anche l'LTV.
