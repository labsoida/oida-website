...
# Progettare un ambulatorio chirurgico: perché il layout è un requisito, non un dettaglio
...
La prima cosa da capire è dove guardare. In Italia l'esercizio delle attività sanitarie da parte delle strutture private è soggetto ad autorizzazione, sulla base del D.Lgs. 502/1992 e successive modificazioni. I requisiti minimi comuni sono fissati dal D.P.R. 14 gennaio 1997, l'atto di indirizzo e coordinamento noto come Decreto Bindi, che li raggruppa in requisiti strutturali, tecnologici e organizzativi e ne demanda alle Regioni l'accertamento, con una verifica periodica della loro permanenza.
...
Per rendere concreta la mappa serve un esempio, e va letto per quello che è: un singolo caso regionale, non lo standard nazionale. La scheda di autorizzazione della Regione Sardegna per l'ambulatorio chirurgico, ad esempio, indica una sala dedicata all'esecuzione delle prestazioni chirurgiche di superficie non inferiore a venti metri quadri, un locale separato per la sosta e la sorveglianza post-prestazione, pareti lavabili fino a due metri di altezza, un ricambio d'aria controllato nel locale operativo, la classificazione del locale a uso medico secondo la norma tecnica CEI di riferimento, e sul piano delle dotazioni la lampada scialitica, l'elettrobisturi e il carrello per la gestione delle emergenze. Sul piano organizzativo compaiono la presenza di un medico responsabile, l'anestesista presente o disponibile in funzione dell'intervento, il consenso informato documentato, il registro operatorio e le procedure per l'emergenza e per l'eventuale trasferimento del paziente in una struttura di ricovero. Altre Regioni fissano valori e articolazioni diversi: questi numeri servono a capire la logica, non a essere copiati.
...
**Fonte:** https://oida-labs.com/blog/progettazione-ambulatorio-chirurgico-requisiti/index.md
