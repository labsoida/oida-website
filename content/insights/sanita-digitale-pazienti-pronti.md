...
tags: ["marketing sanitario", "comunicazione sanitaria", "sanità digitale", "divario digitale", "ai sanità", "front office clinica", "posizionamento strategico"]
stats:
  - number: "54,3"
    suffix: "%"
    label: "delle persone 16–74 anni ha competenze digitali almeno di base (obiettivo UE 2030: 80%)."
  - number: "19,9"
    suffix: "%"
    label: "ha usato strumenti di intelligenza artificiale: penultimo posto UE (media 32,7%)."
  - number: "62,8"
    suffix: "%"
    label: "degli over 75 non usa Internet, con divario Nord–Sud netto in tutte le fasce."
sidebar:
  - label: "Competenze digitali"
    stat: "54,3%"
    note: "delle persone 16–74 anni ha competenze di base. Obiettivo UE 2030: 80%. Italia sotto la media UE di 6,1 punti."
  - label: "Uso dell'IA"
    stat: "19,9%"
    note: "ha usato strumenti di intelligenza artificiale. Penultimo posto UE (media 32,7%). Per istruzione: dal 3,6% al 32,0%."
  - label: "Divario territoriale"
    note: "Competenze di base: Nord 60,0%, Centro 56,9%, Mezzogiorno 44,8%. Famiglie con competenze: Sud 50,1% contro Centro-nord 60,0%."
  - label: "Le fasce escluse"
    note: "Over 75 senza Internet: 62,8% (32,9% se diplomati). Servizi online non usati: identità digitale 34,3%, PA online 36,1%."
  - label: "IA nelle imprese"
    note: "Piccole imprese 14,2%, grandi 53,0%. Ostacolo principale dichiarato: mancanza di competenze interne."
sources:
  primary: "Istituto Nazionale di Statistica. <em>Rapporto annuale 2026. La situazione del Paese.</em> Istat: Roma, maggio 2026. Capitolo 3 (§3.2.4, competenze digitali) e Capitolo 4 (§4.3.1, adozione dell'intelligenza artificiale nelle imprese)."
  secondary: "Digital Competence Framework 2.0 della Commissione europea; Eurostat, <em>EU Survey on ICT usage in households and by individuals</em>, dati 2025."
...
Questa analisi non misura la digitalizzazione delle strutture sanitarie, ma quella dei loro pazienti, perché è da lì che dipende la resa effettiva di ogni scelta di comunicazione digitale. Leggiamo i dati ISTAT dal punto di vista di chi deve decidere su quali canali investire, con quale grado di complessità e per quale pubblico reale, non per quello descritto nei convegni di settore.
{{< /insight-callout >}}
...
{{< insight-data title="Adozione di tecnologie di IA per dimensione d'impresa" subtitle="Imprese con almeno 10 addetti, anno 2025. Fonte: Rapporto annuale ISTAT 2026, §4.3.1" >}}
<table class="insight-data-table">
  <thead><tr><th>Dimensione d'impresa</th><th>Usa almeno una tecnologia di IA</th></tr></thead>
  <tbody>
    <tr><td>Piccole (fino a 49 addetti)</td><td>14,2%</td></tr>
    <tr><td>Medie (50–249 addetti)</td><td>27,0%</td></tr>
    <tr><td>Grandi (250 addetti e oltre)</td><td>53,0%</td></tr>
    <tr><td>Totale (10+ addetti)</td><td>16,4%</td></tr>
  </tbody>
</table>
{{< /insight-data >}}

Oltre metà delle imprese sotto i 250 addetti che hanno considerato l'IA senza adottarla indica come ostacolo principale la mancanza di competenze interne, non il costo. Lo stesso freno che ISTAT rileva tra i cittadini, dove l'uso dell'IA sale dal 3,6 per cento tra chi ha al massimo la licenza media al 32,0 per cento tra chi ha un titolo terziario, si ripresenta dentro le organizzazioni. Per una struttura sanitaria privata, questo ha una doppia implicazione: l'[intelligenza artificiale è una possibilità concreta nel back office](/servizi/intelligenza-artificiale-sanita/), dalla gestione dei contatti al [CRM sanitario](/servizi/crm-automation-sanita/), ma è prematura come interfaccia rivolta a un paziente che, nella maggioranza dei casi, non ha ancora dimestichezza con questi strumenti.
