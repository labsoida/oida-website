...
stats:
  - number: "40,6"
    suffix: "mld €"
    label: "spesa sanitaria out-of-pocket nel 2023: quanto le famiglie italiane hanno pagato direttamente di tasca propria."
  - number: "4,5"
    suffix: "M"
    label: "persone che nel 2023 hanno rinunciato a visite o esami pur avendone bisogno. Per 2,5 milioni il motivo è stato economico."
  - number: "~40"
    suffix: "%"
    label: "la quota della spesa privata out-of-pocket che, secondo le stime GIMBE, è low-value: non contribuisce a migliorare la salute."
sidebar:
  - label: "Spesa privata totale 2023"
    stat: "45,8 mld €"
    note: "40,6 miliardi pagati direttamente dalle famiglie e 5,2 miliardi intermediati da fondi e polizze. La spesa privata è il 26% della spesa sanitaria totale italiana."
  - label: "Pagamenti diretti"
    stat: "88,6%"
    note: "della spesa sanitaria privata italiana è out-of-pocket. Soltanto l'11,4% passa attraverso fondi sanitari o polizze assicurative."
  - label: "Spesa senza valore clinico"
    stat: "~40%"
    note: "della spesa out-of-pocket, pari a circa 16 miliardi di euro, è classificata low-value: non contribuisce a migliorare gli esiti di salute."
  - label: "Rinunce 2023"
    stat: "4,5 M"
    note: "persone hanno rinunciato a visite o esami pur avendone bisogno. Di queste, 2,5 milioni per motivi economici: +600 mila rispetto al 2022."
  - label: "Confronto internazionale"
    note: "Spesa out-of-pocket italiana 1.115 dollari pro-capite, contro 906 della media OCSE e UE. Spesa intermediata 143 dollari, meno della metà della media OCSE (299)."
sources:
  primary: "Fondazione GIMBE, <em>La spesa sanitaria privata in Italia nel 2023</em>. Report Osservatorio GIMBE n.&nbsp;2/2025. Bologna, febbraio 2025. Disponibile a: <a href='https://www.gimbe.org/osservatorio' target='_blank' rel='noopener'>www.gimbe.org/osservatorio</a>."
  secondary: "ISTAT, Sistema dei conti della sanità (SHA), anno 2023; ISTAT, Rapporto BES 2023; ISTAT, Rilevazione sulla povertà in Italia 2023; OCSE, Health Statistics 2024; Sistema Tessera Sanitaria per la dichiarazione dei redditi precompilata; raccomandazione OMS sulla quota ideale di spesa sanitaria privata."
...
### Perché in Italia il paziente paga di tasca propria
...
Questa analisi non discute il merito politico delle scelte di finanziamento del Servizio Sanitario Nazionale e non valuta l'opportunità di un secondo pilastro sanitario, temi che spettano al dibattito pubblico. Legge i dati del Report GIMBE dal punto di vista di chi gestisce una struttura sanitaria privata e deve capire dove si trova la propria domanda effettiva, come è composta e quanto è realmente solvibile. La nostra lettura è parallela a quella di sistema, non alternativa.
{{< /insight-callout >}}
...
## Perché il mercato sanitario privato italiano è più grande di quello europeo
...
### Dove va la spesa out-of-pocket delle famiglie italiane
...
<figure class="insight-data-block">
  <figcaption class="insight-data-block__title">Le voci principali della spesa out-of-pocket 2023</figcaption>
  <div class="insight-data-block__subtitle">Fonte: Report Osservatorio GIMBE 2/2025 su dati ISTAT-SHA, anno 2023. Quote arrotondate.</div>
  <div class="insight-data-table-wrap">
    <table class="insight-data-table">
      <thead>
        <tr><th>Voce di spesa</th><th>Valore (mld €)</th><th>Quota</th></tr>
      </thead>
      <tbody>
        <tr><td>Assistenza per cura e riabilitazione (incl. odontoiatria)</td><td>18,1</td><td>44,6%</td></tr>
        <tr><td>Prodotti farmaceutici e apparecchi terapeutici</td><td>15,0</td><td>36,9%</td></tr>
        <tr><td>Assistenza a lungo termine (LTC)</td><td>4,4</td><td>10,9%</td></tr>
        <tr><td>Altre voci</td><td>3,1</td><td>7,6%</td></tr>
      </tbody>
    </table>
  </div>
</figure>
...
### Lo spazio di posizionamento per una struttura sanitaria privata
...
## Rinuncia alle cure: dove la domanda sanitaria non si converte
...
### La rinuncia alle cure regione per regione
...
<figure class="insight-data-block">
  <figcaption class="insight-data-block__title">Rinuncia alle cure per ripartizione geografica (2023)</figcaption>
  <div class="insight-data-block__subtitle">Fonte: Report Osservatorio GIMBE 2/2025 su dati ISTAT BES 2023.</div>
  <div class="insight-data-table-wrap">
    <table class="insight-data-table">
      <thead>
        <tr><th>Ripartizione</th><th>Persone che hanno rinunciato</th></tr>
      </thead>
      <tbody>
        <tr><td>Centro</td><td>8,8%</td></tr>
        <tr><td>Isole</td><td>8,6%</td></tr>
        <tr><td>Nord-Ovest</td><td>7,7%</td></tr>
        <tr style="font-weight:600;color:var(--teal)"><td>Italia (media nazionale)</td><td>7,6%</td></tr>
        <tr><td>Sud</td><td>7,3%</td></tr>
        <tr><td>Nord-Est</td><td>6,4%</td></tr>
      </tbody>
    </table>
  </div>
</figure>

### Quale parte della rinuncia alle cure è davvero convertibile
...
### La liquidità delle famiglie e i funnel che si rompono
...
## Che cosa dice il Report GIMBE a chi gestisce una struttura privata

Il Report GIMBE 2/2025 è un documento di analisi della spesa sanitaria pubblica e privata italiana, costruito per informare il dibattito politico-sanitario sulla sostenibilità del Servizio Sanitario Nazionale e sul ruolo della sanità integrativa. Ciò che restituisce, però, è anche il quadro più aggiornato oggi disponibile del mercato in cui una struttura sanitaria privata italiana opera, con misure precise sulla sua dimensione (45,8 miliardi di euro, di cui 40,6 pagati direttamente dalle famiglie), sulla sua composizione (88,6% diretto, 11,4% intermediato), sul suo divario di valore (quasi il 40% della spesa diretta non genera salute), sul suo limite (4,5 milioni di rinunce, di cui 2,5 economiche) e sulla sua distribuzione geografica. Il ruolo ancora marginale dei fondi e delle polizze, appena l'11,4% della spesa privata, è il contesto in cui si gioca il dibattito sui [fondi sanitari integrativi e le strutture private](/blog/fondi-sanitari-integrativi-strutture-private/). Sul versante degli esiti, e non della spesa, la stessa domanda si legge nell'analisi su [prevenzione e divari territoriali nella salute degli italiani](/insights/prevenzione-divari-territoriali-domanda-sanitaria/).

{{< insight-conclusion label="La lettura di OIDA Labs" >}}
Chi gestisce una struttura sanitaria privata italiana non si trova davanti un mercato che richiede di essere generato. Si trova davanti un mercato che esiste, vale quasi 46 miliardi di euro, è composto per quasi nove decimi da pagamenti diretti delle famiglie e, dentro di sé, contiene un divario misurabile tra prestazioni che generano salute e prestazioni che ne generano apparenza. La domanda non manca: ciò che manca, spesso, è una lettura sobria di quanto sia grande, di come sia composta e di dove finisce la sua capacità di tradursi in conversione effettiva.

Il compito, per il marketing sanitario di una struttura privata, è scegliere il lato del mercato su cui collocarsi. Posizionarsi sul valore della singola prestazione, comunicando pertinenza clinica, trasparenza dell'indicazione e qualità documentata del percorso, significa intercettare la quota di spesa privata che effettivamente migliora gli esiti di salute. Posizionarsi sul volume, alimentando consumismo o promettendo prestazioni in eccesso, significa partecipare a un mercato che il Report stesso documenta come per il 40% privo di valore clinico, e che prima o poi si erode da solo. La distinzione non è etica nel senso astratto: è di sostenibilità della struttura nel medio periodo.

È il genere di analisi che, nella nostra prassi, chiamiamo flusso lento: una lettura che parte dal dato pubblico di sistema e ne ricava le coordinate operative per chi quella domanda dovrebbe saperla accogliere. Il Report GIMBE non parla di marketing sanitario. Ma chi opera nella sanità privata trova, fra le sue tavole, la mappa più precisa del proprio mercato di riferimento e dei suoi confini.
{{< /insight-conclusion >}}
