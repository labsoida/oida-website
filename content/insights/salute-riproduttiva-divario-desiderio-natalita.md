...
stats:
  ...
  - number: "355"
    suffix: " mila"
    label: "nati nel 2025: meno della metà di quelli attesi dalle intenzioni dichiarate."
  - number: "6,6"
    suffix: "M"
    label: "persone che dichiarano di aver rinunciato ai figli che desideravano."
sidebar:
  - label: "Fecondità 2025"
    stat: "1,14"
    note: "figli per donna, minimo storico italiano. Nord-est 1,17, Centro 1,07. Fonte: ISTAT 2026."
  - label: "Età media al parto"
    stat: "32,7"
    note: "anni nel 2025, in crescita costante. Centro 33,1, Isole 32,0. Spinge la domanda verso la fertilità tardiva."
  - label: "Divario desideri–realtà"
    note: "Nascite attese dalle intenzioni: ~760 mila l'anno. Nascite reali 2025: 355 mila. Numero di figli più desiderato: due (41,7%)."
  - label: "Domanda non realizzata"
    note: "6,6 milioni hanno rinunciato ai figli desiderati. Di questi, 1,3 milioni per il tempo trascorso (problemi di età)."
  - label: "Geografia"
    note: "Concentrazione del bacino solvibile nelle aree urbane del Centro-nord. Nei comuni centro delle aree metropolitane il 28,7% delle persone arriva a 50 anni senza figli."
sources:
  primary: "Istituto Nazionale di Statistica. <em>Rapporto annuale 2026. La situazione del Paese.</em> Istat: Roma, maggio 2026. Capitolo 2, Popolazione e società, §2.1.1 e §2.1.2."
  secondary: "Istat, <em>Indicatori demografici. Anno 2025</em> (Statistiche Report, marzo 2026); Istat, <em>Intenzioni di fecondità. Anno 2024</em> (Statistiche Report, dicembre 2025)."
...
Questa analisi non discute le politiche per la natalità e non entra nel merito clinico dei percorsi di fertilità. Guarda ai dati ISTAT dal punto di vista della comunicazione sanitaria e del posizionamento delle strutture private che operano nella medicina della riproduzione, nella ginecologia della fertilità e nella diagnostica preconcezionale. La domanda di cui parliamo esiste già: la questione è quando, e con quale messaggio, viene intercettata.
{{< /insight-callout >}}
...
{{< insight-data title="Nascite attese dalle intenzioni e nascite reali" subtitle="Stima ISTAT su intenzioni riproduttive delle donne in età fertile, confronto con le nascite registrate. Valori annui" >}}
<table class="insight-data-table">
  <thead><tr><th>Fonte del dato</th><th>Nascite annue</th></tr></thead>
  <tbody>
    <tr><td>Attese dalle intenzioni dichiarate</td><td>~760 mila</td></tr>
    <tr><td>Nate realmente (2025)</td><td>355 mila</td></tr>
    <tr><td>Scarto</td><td>oltre 400 mila l'anno</td></tr>
  </tbody>
</table>
{{< /insight-data >}}
...
{{< insight-data title="Persone di 50 anni e più senza figli" subtitle="Quota sulla popolazione della fascia, confronto 2003 e 2024. Fonte: ISTAT 2026, §2.1.2" >}}
<table class="insight-data-table">
  <thead><tr><th>Anno</th><th>Quota della fascia</th></tr></thead>
  <tbody>
    <tr><td>2003</td><td>12,9%</td></tr>
    <tr><td>2024</td><td>22,8%</td></tr>
    <tr><td>2024 (comuni centro aree metropolitane)</td><td>28,7%</td></tr>
  </tbody>
</table>
{{< /insight-data >}}
...
{{< insight-data title="Indicatori riproduttivi per ripartizione geografica" subtitle="Anno 2025 per la fecondità, 2024 per le intenzioni. Fonte: Rapporto annuale ISTAT 2026, §2.1.1–2.1.2" >}}
<table class="insight-data-table">
  <thead><tr><th>Ripartizione</th><th>Figli per donna</th><th>Incerti sul numero desiderato</th></tr></thead>
  <tbody>
    <tr><td>Nord-est</td><td>1,17</td><td>28,1% (dato Nord)</td></tr>
    <tr><td>Nord-ovest</td><td>~1,15</td><td>28,1% (dato Nord)</td></tr>
    <tr><td>Centro</td><td>1,07</td><td>36,6%</td></tr>
    <tr><td>Mezzogiorno</td><td>~1,14</td><td>45,1%</td></tr>
  </tbody>
</table>
{{< /insight-data >}}
...
{{< insight-conclusion >}}
Chi gestisce un centro di procreazione medicalmente assistita, un ambulatorio di ginecologia della fertilità o un percorso di preservazione della fertilità non ha davanti un mercato da convincere dell'esistenza del bisogno. Ha una domanda che si è già formata, fatta di milioni di progetti rinviati, e che il sistema pubblico intercetta tardi e in modo diseguale sul territorio. Il bisogno c'è. Quello che manca, spesso, è l'incontro nel momento giusto.

Il compito non è clinico, ma di posizionamento e di contenuto: farsi trovare nella fase a monte, quella in cui una persona o una coppia comincia a interrogarsi sui tempi della fertilità, invece che solo a valle, quando la difficoltà è conclamata; parlare il linguaggio della consapevolezza e non quello dell'emergenza; e calibrare il messaggio sul territorio, perché un pubblico urbano del Centro-nord e un pubblico del Mezzogiorno non si trovano nello stesso punto del proprio percorso decisionale.

È il genere di analisi che, nella nostra prassi, chiamiamo flusso lento: una lettura che parte dal dato pubblico di sistema e ne ricostruisce le implicazioni per chi quella domanda dovrebbe saperla accogliere. Il Rapporto ISTAT non le enuncia. Ma chi lavora nella salute riproduttiva privata le trova, fra le sue tavole, già scritte.
{{< /insight-conclusion >}}
