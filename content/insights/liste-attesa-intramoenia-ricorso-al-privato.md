---
title: "Liste d'attesa e intramoenia: cosa fa il paziente quando il pubblico non risponde"
seo_title: "Liste d'attesa e ricorso al privato"
description: "L'indagine FNOMCeO-Piepoli 2026 letta da OIDA Labs: davanti alle liste d'attesa quasi due italiani su tre scelgono il privato o l'intramoenia."
date: 2026-07-08
lastmod: 2026-07-08
author: "OIDA Labs"
...
stats:
  - number: "63"
    suffix: "%"
    label: "quota di italiani che, davanti a tempi di attesa lunghi, sceglie come comportamento principale una via a pagamento (privato o intramoenia) invece di aspettare nel Servizio Sanitario Nazionale."
  - number: "43"
    suffix: "%"
    label: "ha fatto ricorso all'intramoenia almeno una volta, il 22% più di una volta. È un canale di massa, non un'eccezione, e per una struttura privata è un competitor diretto."
  - number: "69"
    suffix: "%"
    label: "si fida delle strutture sanitarie private accreditate, un livello vicino a quello dei medici ospedalieri pubblici (72%). Il privato accreditato parte da un capitale di fiducia alto."
sidebar:
  - label: "Il comportamento, nel dettaglio"
    stat: "29% + 25% + 9%"
    note: "A fronte di attese lunghe, il comportamento principale: privato convenzionato 29%, privato non convenzionato 25%, intramoenia 9%. Solo il 21% aspetta nel SSN, il 7% rinuncia."
  - label: "Conoscenza contro comprensione"
    stat: "81% vs 47%"
    note: "L'81% conosce l'intramoenia, ma solo il 47% ne capisce il funzionamento. Un divario di comprensione che una struttura può colmare con la chiarezza del proprio percorso."
  - label: "La geografia del ricorso"
    stat: "54%"
    note: "Ricorso all'intramoenia al Centro (una o più volte), contro il 35% del Nord-ovest. Anche il comportamento della domanda ha una geografia."
  - label: "Il trigger: i tempi di attesa"
    stat: "2,3 mesi"
    note: "Attesa media dichiarata per una prestazione; il 68% giudica negativamente i tempi del SSN. È il momento in cui la domanda decide di pagare."
  - label: "Cosa chiede il paziente"
    note: "Tra le misure ritenute utili contro le liste d'attesa, l'80% indica tempi di attesa pubblici e aggiornati in tempo reale. La domanda di trasparenza è esplicita."
sources:
  primary: "Istituto Piepoli per la Federazione Nazionale degli Ordini dei Medici Chirurghi e degli Odontoiatri (FNOMCeO), <em>Il rapporto degli italiani con l'intramoenia e le liste d'attesa: conoscenza, percezioni e aspettative</em>. Indagine quantitativa, 1.000 interviste CATI/CAWI a popolazione italiana di 18 anni e più, 22-26 giugno 2026."
...
### Il comportamento della domanda nel momento in cui il paziente decide
...
## Che cosa fa il paziente quando l'attesa si allunga
...
### Quanti pazienti scelgono di pagare invece di aspettare
...
### Che cosa significa per chi gestisce una struttura sanitaria privata
...
## Quanto è diffusa l'intramoenia e quanto i pazienti la comprendono
...
### Il divario tra conoscenza e comprensione dell'intramoenia
...
## Quanta fiducia hanno gli italiani nelle strutture sanitarie private
...
### La trasparenza sui tempi di attesa come richiesta esplicita dei pazienti
...
## Che cosa dicono questi dati a una struttura sanitaria privata
