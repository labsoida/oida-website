...
Le campagne **lead generation** con form diretto su Meta producono CPL generalmente inferiori rispetto alle campagne che portano al sito, ma richiedono un processo di follow-up rapido: i lead raccolti su form Meta hanno un tasso di risposta che decade significativamente dopo le prime ore. Il tema dell'automazione del follow-up è trattato nell'articolo su [chatbot e automazione della prima risposta](/blog/chatbot-e-automazione-della-prima-risposta-nelle-strutture-sanitarie-cosa-funziona-e-cosa-non-funziona/).
