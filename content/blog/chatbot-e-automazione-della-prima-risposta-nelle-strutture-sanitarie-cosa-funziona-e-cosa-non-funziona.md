...
faqs:
  ...
  - q: "Qual è il costo di implementazione realistico di un sistema di automazione per una struttura di medie dimensioni?"
    a: "La variabilità è ampia, dipende dall'integrazione con i sistemi esistenti, dalla complessità dei flussi di conversazione e dalla piattaforma scelta. Le strutture che partono da sistemi di prenotazione già digitali hanno costi di implementazione inferiori rispetto a quelle che devono digitalizzare prima i processi di base. Il punto da valutare non è il costo assoluto ma il costo rapportato al valore dei lead che attualmente vengono persi per ritardo nella risposta."
  - q: "La normativa sulla privacy in sanità limita l'uso dei chatbot per la raccolta di informazioni sui pazienti?"
    a: "I chatbot che raccolgono informazioni legate alla salute dei pazienti sono soggetti alle disposizioni del GDPR in materia di trattamento di dati sanitari, classificati come dati particolari che richiedono base giuridica specifica e misure di sicurezza rafforzate. La configurazione del chatbot, i dati che raccoglie e come li archivia devono essere verificati da un DPO o da un consulente privacy specializzato nel settore sanitario prima dell'implementazione."
draft: false
---
...
1. [Il problema della prima risposta: perché il ritardo è più costoso di quanto sembra](#il-problema-della-prima-risposta)
2. [Cosa può fare un chatbot e cosa non può fare](#cosa-puo-fare-un-chatbot-e-cosa-non-puo-fare)
3. [Dove l'automazione funziona e dove fallisce](#dove-lautomazione-funziona-e-dove-fallisce)
4. [Integrazione con CRM e processi umani](#integrazione-con-crm-e-processi-umani-il-punto-critico)
5. [Metriche per valutare se l'automazione funziona davvero](#metriche-per-valutare-se-lautomazione-funziona-davvero)
6. [FAQ](#faq)
...
- Confermare la ricezione di una richiesta di contatto
- Fornire informazioni non cliniche su orari, professionisti e specialità
- Raccogliere informazioni per qualificare la richiesta prima dell'intervento umano
- Guidare il paziente verso il canale più appropriato

Non può fare, e non deve tentare di fare:
- Valutare l'urgenza clinica di un sintomo
- Fornire informazioni sui prezzi se variano in funzione di variabili che richiedono valutazione
- Gestire conversazioni con pazienti che esprimono ansia o difficoltà emotive
- Sostituire il giudizio umano nei momenti in cui la relazione conta
...
Le implicazioni per la scelta e la configurazione del CRM sono approfondite nell'articolo su [CRM sanitario e gestione dei lead nel poliambulatorio](/blog/crm-sanitario-poliambulatorio-perche-strutture-perdono-pazienti/).
...
- Tasso di conversione da contatto digitale a prenotazione confermata (prima e dopo l'implementazione)
- Tempo medio tra primo contatto e prenotazione
- Percentuale di lead digitali che non ricevono follow-up manuale entro i tempi definiti
- Volume di prenotazioni nelle finestre orarie fuori orario del front office
