---
title: "Google Ads per strutture sanitarie: anatomia di una campagna che non funziona"
seo_title: "Google Ads per medici e strutture sanitarie: 5 errori"
...
sources: "Google Ads, policy Healthcare and medicines; Legge 145/2018, art. 1, commi 525 e 536, e successive modifiche (D.L. 69/2023), disciplina della comunicazione sanitaria in Italia; Regolamento UE 2016/679 (GDPR), art. 9, trattamento di categorie particolari di dati; Dati interni OIDA Labs su campagne Search per strutture sanitarie private monitorate tra il 2023 e il 2025."
faqs:
  ...
  - q: "Quanto tempo serve prima di capire se una campagna Google Ads funziona?"
    a: "Le prime indicazioni utili arrivano in quattro-otto settimane, a condizione che il tracciamento sia attivo dal primo giorno. Servono dati sufficienti sui termini di ricerca reali, sul tasso di conversione per keyword e sul costo per paziente per specialità. Valutare una campagna sui clic dopo pochi giorni porta a decisioni sbagliate: il segnale che conta è quanti contatti diventano appuntamenti, e quel dato richiede qualche settimana per consolidarsi."
  - q: "Conviene gestire Google Ads internamente o affidarsi a chi è specializzato in sanità?"
    a: "La differenza non è tra interno ed esterno, è tra chi conosce i vincoli del settore e chi no. La gestione di campagne sanitarie richiede competenza sulle policy di Google per la sanità, sulla normativa italiana e sul tracciamento conforme al GDPR. Una gestione che ignora questi vincoli espone la struttura a sospensioni dell'account e a rischi di conformità, oltre a sprecare budget. Chi gestisce, internamente o esternamente, deve padroneggiare questi tre piani."
draft: false
---
...
1. [Errore 1: keyword troppo generiche](#errore-1-keyword-troppo-generiche)
2. [Errore 2: nessuna lista di parole chiave a corrispondenza inversa](#errore-2-nessuna-lista-di-parole-chiave-a-corrispondenza-inversa)
3. [Errore 3: la stessa pagina di destinazione per ogni annuncio](#errore-3-la-stessa-pagina-di-destinazione-per-ogni-annuncio)
4. [Errore 4: nessun tracciamento delle conversioni reali](#errore-4-nessun-tracciamento-delle-conversioni-reali)
5. [Errore 5: budget piatto su una domanda stagionale](#errore-5-budget-piatto-su-una-domanda-stagionale)
6. [I cinque errori in sintesi](#i-cinque-errori-in-sintesi)
7. [FAQ](#faq)
...
L'errore nasce da una metrica fuorviante: la campagna generica porta più clic e più lead apparenti, quindi sembra performare meglio. Misurata sui pazienti che si presentano, performa quasi sempre peggio. La distinzione tra il costo del lead e il costo del paziente acquisito è il fulcro di questo ragionamento, ed è approfondita nel blog su [CPL e CAC nel marketing sanitario](/blog/cpl-cac-marketing-sanitario-metrica-redditivita/).
