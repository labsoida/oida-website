...
og_image: "img/blog/gdpr-studi-medici-dentistici-og.jpg"
image_alt: "GDPR per studi medici e dentistici: dove tocca il marketing e la comunicazione"
tags: ["normativa", "strategia"]
servizio: "crm-automation-sanita"
sources: "Regolamento UE 2016/679 (GDPR), artt. 9 e 83; Garante per la protezione dei dati personali, Provv. n. 55 del 7 marzo 2019 (chiarimenti sul trattamento dei dati sanitari); Garante, Linee guida cookie n. 231 del 10 giugno 2021; Garante, provvedimento sull'uso di Google Analytics (giugno 2022) e Commissione UE, decisione di adeguatezza EU-US Data Privacy Framework (10 luglio 2023); Garante, Compendio sulle piattaforme di contatto pazienti-professionisti sanitari (2024); Garante, Provv. 11 gennaio 2024 (diffusione video di procedura estetica); Legge 145/2018 (comma 525) come modificata dal D.L. 69/2023 convertito in Legge 103/2023."
faqs:
  - q: "Serve il consenso privacy dei pazienti per curarli?"
    a: "No. Per le prestazioni di cura il professionista tenuto al segreto professionale non deve richiedere il consenso privacy, perché la base giuridica è la finalità di cura stessa (art. 9.2.h GDPR; Garante, 2019). Il consenso privacy torna necessario solo per le finalità diverse dalla cura, come il marketing. Resta invece sempre dovuto il consenso informato all'atto medico o odontoiatrico (Legge 219/2017): è un istituto distinto, che non va confuso con quello privacy."
  - q: "Posso inviare una newsletter promozionale alla mia lista pazienti?"
    a: "Solo con un consenso marketing raccolto separatamente rispetto al rapporto di cura. Una comunicazione promozionale o di richiamo non può appoggiarsi alla base giuridica della cura: richiede un consenso libero, specifico per la finalità di marketing, revocabile con facilità e documentato. Lo stesso vale per la segmentazione dei pazienti nel CRM a fini promozionali."
  - q: "Google Analytics è vietato per il sito di uno studio sanitario?"
    a: "No, non è vietato. Nel 2022 il Garante ne aveva contestato l'uso per il trasferimento dei dati verso gli Stati Uniti, ma dal luglio 2023 quel trasferimento è coperto dall'accordo EU-US Data Privacy Framework, a cui Google aderisce: lo strumento è utilizzabile con il contratto adeguato e l'anonimizzazione dell'indirizzo IP. Il quadro resta soggetto a un contenzioso ancora aperto, per cui alcuni studi scelgono per prudenza strumenti di analisi con server europei."
  - q: "Posso pubblicare la recensione, la foto o il prima e dopo di un paziente?"
    a: "Sul piano privacy serve il consenso esplicito, scritto, specifico e revocabile alla diffusione, perché l'immagine di un paziente riconoscibile è un dato sulla salute. Ma il consenso non basta: sul piano deontologico la normativa sulla pubblicità sanitaria esclude gli elementi attrattivi e suggestivi, per cui testimonial costruiti e immagini del risultato restano esposti anche con il consenso. La recensione autentica e spontanea è generalmente ammessa; l'uso attivo di testimonial e prima e dopo è terreno di rischio."
  - q: "Il mio piccolo studio è esente dal registro dei trattamenti perché ho pochi dipendenti?"
    a: "No. L'esenzione prevista per chi ha meno di 250 dipendenti non si applica a chi tratta dati sanitari in modo non occasionale, e il Garante lo ha chiarito espressamente anche per il singolo professionista sanitario. Il registro delle attività di trattamento va quindi tenuto anche dallo studio di piccole dimensioni. È un adempimento che compete al responsabile della protezione dei dati e al consulente legale della struttura."
draft: false
---

I dati dei pazienti sono la categoria di informazioni che il GDPR protegge più severamente, e per uno studio medico o dentistico la posta in gioco è concreta: le sanzioni per un trattamento illecito di dati sulla salute arrivano fino a 20 milioni di euro o al 4% del fatturato (art. 83 GDPR). Il punto, per una struttura, non è però diventare esperta di privacy, ma evitare che il proprio marketing si trasformi in un problema. Gli adempimenti strutturali, dal registro dei trattamenti alla nomina del responsabile della protezione dei dati, restano il terreno del consulente legale e del DPO; questa guida guarda invece al punto in cui la privacy incrocia la comunicazione e l'acquisizione dei pazienti, che è il terreno del marketing. Le regole generali del settore sono nella [guida al marketing sanitario](/marketing-sanitario/); qui vediamo dove il **GDPR** tocca concretamente il lavoro di uno studio.

---

1. [La regola che governa tutto: cura senza consenso, marketing con consenso](#la-regola-che-governa-tutto)
