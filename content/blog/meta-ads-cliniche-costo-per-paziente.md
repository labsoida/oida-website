---
title: "Meta Ads per cliniche: come calcolare il costo per paziente (e smettere di guardare il CPL)"
seo_title: "Meta Ads per cliniche: il costo per paziente reale"
...
tags: ["advertising", "metriche e kpi"]
servizio: "advertising-sanitario"
sources: "Meta, Politiche pubblicitarie per il settore sanitario e farmaceutico (Advertising Standards); Legge 145/2018, art. 1, commi 525 e 536, come modificata dalla Legge 103/2023 e dal D.L. 69/2023, disciplina della comunicazione sanitaria in Italia; dati interni OIDA Labs su campagne Meta per strutture sanitarie private monitorate tra il 2023 e il 2025 (specialità monitorate: fisioterapia, odontoiatria, medicina estetica, ortopedia e ginecologia); InsideSales.com / MIT Sloan, Lead Response Management Study."
faqs:
  - q: "Qual è un costo per paziente accettabile su Meta per una struttura sanitaria?"
    a: "Non esiste un valore unico, dipende dal valore del paziente nel tempo per la specialità. Per una prestazione una tantum di basso importo, un costo per paziente di 150 euro è insostenibile; per una specialità a ricorrenza alta come la fisioterapia o l'odontoiatria, dove il valore del paziente nel primo anno supera spesso il migliaio di euro, lo stesso costo è ampiamente sostenibile. Il riferimento corretto è il rapporto tra costo per paziente e valore del paziente, non il costo per paziente in sé."
  - q: "Meta Ads o Google Ads: da quale partire se il budget è limitato?"
    a: "Dipende dalla specialità che si vuole far crescere. Se è una prestazione che il paziente cerca attivamente, Search produce pazienti più in fretta e con conversione più alta, quindi è il punto di partenza. Se è una prestazione a domanda latente, Meta è più adatto, ma richiede creatività curata e un processo di richiamo rapido per non disperdere i contatti freddi. Con budget limitato, concentrarlo su un solo canale coerente con la specialità rende più dei due canali sottofinanziati in parallelo."
  - q: "Perché i lead da Meta sembrano di qualità più bassa di quelli da altri canali?"
    a: "Perché lo sono per natura, non per errore della campagna. Il lead da Meta arriva da una persona che non stava cercando la prestazione, quindi è meno avanti nel percorso decisionale rispetto a chi ha cercato su Google. Questo non lo rende privo di valore: lo rende un contatto da accompagnare, che richiede un primo richiamo rapido e una qualificazione attenta. Trattare un lead freddo come uno caldo, o scartarlo perché non prenota subito, è il modo più comune di sprecare il budget Meta."
draft: false
---
...
1. [Perché il CPL su Meta dice meno di quanto sembra](#perche-il-cpl-su-meta-dice-meno-di-quanto-sembra)
2. [Dal CPL al costo per paziente: il calcolo che conta](#dal-cpl-al-costo-per-paziente-il-calcolo-che-conta)
3. [Cosa rende efficace una campagna Meta sanitaria](#cosa-rende-efficace-una-campagna-meta-sanitaria)
4. [I limiti di targeting introdotti da Meta e come lavorarci](#i-limiti-di-targeting-introdotti-da-meta-e-come-lavorarci)
5. [Quando Meta Ads non è il canale giusto](#quando-meta-ads-non-e-il-canale-giusto)
6. [FAQ](#faq)
...
Il costo per paziente, cioè il CAC, è il CPL diviso per il prodotto di tutti i tassi di conversione che separano il lead dalla visita effettiva. Su Meta la catena ha più anelli che su Search, e ogni anello erode. La distinzione tra le due metriche, valida per ogni canale, è approfondita nell'articolo su [CPL e CAC nel marketing sanitario](/blog/cpl-cac-marketing-sanitario-metrica-redditivita/).
...
Dati interni OIDA Labs su strutture monitorate tra il 2023 e il 2025 mostrano che, sullo stesso canale Meta, il costo per paziente varia di oltre tre volte tra strutture con CPL quasi identico. La differenza non è nel costo del clic, è in cosa succede dopo il clic: velocità di richiamo, qualità del primo contatto e coerenza tra l'annuncio e la pagina di destinazione. Il modo in cui questa coerenza determina la conversione post-clic è analizzato nell'articolo sulla [landing page sanitaria](/blog/landing-page-sanitaria-conversione/).
...
Il terzo è la gestione del contatto a valle. Un lead da Meta è freddo e ha una finestra di attenzione breve: richiamarlo entro pochi minuti cambia il tasso di conversione in modo misurabile. Una campagna Meta tecnicamente impeccabile collegata a un front desk che richiama il giorno dopo produce costi per paziente fuori controllo. Su come questa velocità incide sulla conversione, l'articolo sull'[acquisizione pazienti online](/blog/acquisizione-pazienti-online-cosa-determina-la-conversione-da-contatto-a-visita/) riporta i dati di riferimento.
...
Le regole pubblicitarie di Meta per il settore sanitario, insieme ai vincoli normativi italiani sulla comunicazione sanitaria definiti dalla Legge 145/2018, art. 1, commi 525 e 536, come modificata dalla Legge 103/2023 e dal D.L. 69/2023, stabiliscono cosa è ammesso e cosa è vietato negli annunci stessi. Il quadro normativo completo, valido sia per Meta sia per Google, è trattato nell'articolo sull'[advertising sanitario su Google e Meta](/blog/advertising-sanitario-su-google-e-meta-normative-limiti-e-strategie-per-strutture-private-in-italia/).
