...
date: 2026-06-12
author: "OIDA Labs"
image: "img/blog/no-show-strutture-sanitarie-private.webp"
og_image: "img/blog/no-show-strutture-sanitarie-private-og.jpg"
image_alt: "No-show nelle strutture sanitarie private: quanto costa davvero e come ridurlo"
tags: ["metriche e kpi", "crm e automazioni"]
servizio: "crm-automation-sanita"
sources: "Kheirkhah P., Feng Q., Travis L.M. et al., Prevalence, predictors and economic consequences of no-shows, BMC Health Services Research 2016, 16:13 (tasso medio di mancata presentazione 18,8% in un sistema ospedaliero pubblico statunitense, Veterans Affairs); Dati interni OIDA Labs su strutture sanitarie private monitorate tra il 2023 e il 2025 (tassi di mancata presentazione per specialità e per canale di prenotazione)."
faqs:
  - q: "Qual è un tasso di no-show considerato fisiologico per una struttura privata?"
    a: "Non esiste una soglia unica valida per tutte le specialità: il tasso varia con il tipo di prestazione, il canale di prenotazione e l'intervallo tra prenotazione e visita. Più che a un valore di riferimento esterno, conviene guardare al proprio dato nel tempo e alla sua distribuzione per specialità e per canale. Il segnale che conta non è siamo sopra o sotto la media, è in quali specialità e da quali canali perdiamo più presentazioni, e perché."
  - q: "I promemoria automatici bastano a risolvere il problema?"
    a: "Risolvono la quota di no-show dovuta a dimenticanza, che è significativa ma non è il totale. Non agiscono sui ripensamenti, sulle doppie prenotazioni in più strutture e sugli appuntamenti fissati con troppo anticipo. Una struttura che implementa solo i promemoria vede un miglioramento e poi un plateau: oltre quel punto servono interventi sulle altre cause, dalla rapidità del primo contatto alla facilità di spostare un appuntamento."
  - q: "Chiedere una caparra per le visite riduce il no-show o allontana i pazienti?"
    a: "Fa entrambe le cose, ed è per questo che va calibrata. Una conferma o una caparra riduce le mancate presentazioni perché introduce un impegno, ma aggiunge anche attrito alla prenotazione, e un attrito eccessivo riduce le prenotazioni legittime. Funziona meglio sulle prime visite ad alto valore, dove la perdita di un no-show è alta, e va comunicata con chiarezza al momento della prenotazione. Applicarla indiscriminatamente a ogni appuntamento rischia di costare più prenotazioni di quante ne salvi."
draft: false
---
...
1. [Perche il no-show e una perdita invisibile](#perche-il-no-show-e-una-perdita-invisibile)
2. [Come si calcola il costo reale di una mancata presentazione](#come-si-calcola-il-costo-reale-di-una-mancata-presentazione)
3. [Le cause del no-show non sono tutte uguali](#le-cause-del-no-show-non-sono-tutte-uguali)
4. [Cosa riduce il no-show in modo misurabile](#cosa-riduce-il-no-show-in-modo-misurabile)
5. [Il no-show come metrica di marketing](#il-no-show-come-metrica-di-marketing)
6. [FAQ](#faq)
...
Il calcolo va fatto per specialità, perché il valore dello slot e il valore del paziente nel tempo cambiano molto. Un no-show su una prestazione una tantum di basso importo pesa diversamente da un no-show su una prima visita che avrebbe aperto un ciclo di trattamento. Inserire questa metrica nel cruscotto mensile, accanto agli altri indicatori, la rende un numero gestibile invece che una perdita silenziosa. Quali indicatori affiancarle in un report mensile utile alle decisioni è il tema dell'articolo sui [KPI del marketing sanitario](/blog/kpi-del-marketing-sanitario-come-misurare-quello-che-conta-davvero/).
...
La terza è la doppia prenotazione: il paziente fissa lo stesso tipo di visita in più strutture e si presenta dove viene richiamato prima o dove percepisce più affidabilità. Qui la leva non è il promemoria, è la qualità e la rapidità del primo contatto, che ancorano la scelta del paziente. Come la velocità del front desk incide su questo passaggio è analizzato nell'articolo sul [front office di una clinica privata](/blog/front-office-di-una-clinica-privata-cosa-determina-la-conversione-al-primo-contatto/).
...
La prima è un sistema di promemoria e conferma, idealmente su un canale ad alta apertura, che ricorda l'appuntamento e offre con un tocco la possibilità di confermarlo o spostarlo. I sistemi di reminder e conferma riducono il no-show in modo misurabile nelle strutture che li adottano, come documentato nell'articolo sul [funnel paziente nelle strutture sanitarie private](/blog/il-funnel-paziente-nelle-strutture-sanitarie-private-dove-si-perdono-i-contatti-e-come-tracciarlo/).
