...
sources: "Decreto-legge 179/2012 art. 12 (conv. L. 221/2012) e successive modificazioni; D.L. 34/2020 art. 11 (alimentazione automatica del FSE); Decreto del Ministero della Salute 7 settembre 2023 (regole tecniche FSE 2.0); Decreto del Ministero della Salute 30 dicembre 2024 (disciplina transitoria, art. 27-bis); Decreto del Ministero della Salute 11 novembre 2025 (conferma del termine del 31 marzo 2026 per la Fase 3); Garante per la protezione dei dati personali, provvedimenti e FAQ in materia di FSE; PNRR Missione 6 Salute investimento 1.3."
faqs:
  - q: "Il paziente deve dare il consenso per l'inserimento dei propri dati nel FSE?"
    a: "Con il FSE 2.0 l'alimentazione del Fascicolo è automatica e non richiede più il consenso del paziente: si fonda su una base normativa legata alla finalità di cura. Ciò che resta soggetto a consenso è la consultazione dei dati da parte di altri professionisti, che il cittadino può concedere o negare e revocare in qualsiasi momento, senza che questo pregiudichi l'erogazione della prestazione. Al paziente resta inoltre il diritto di oscurare singoli dati o documenti, prima o dopo l'inserimento. La struttura deve informare correttamente il paziente su alimentazione, consultazione e diritto di oscuramento."
  - q: "Una struttura privata non accreditata è obbligata a integrare il FSE?"
    a: "Dal 31 marzo 2026 l'obbligo di alimentazione del FSE si estende anche ai documenti delle prestazioni erogate privatamente, quindi in linea di principio riguarda anche le strutture non accreditate. Le associazioni di categoria osservano però che, per queste strutture, l'obbligo non è ancora pienamente esigibile sul piano pratico, perché i gateway regionali non sono attivi ovunque e il regime sanzionatorio non è ancora dettagliato. È una lettura delle categorie, non una proroga di legge: la data è in vigore e la direzione è chiara, quindi conviene prepararsi anziché attendere. Ogni struttura verifica lo stato di attuazione con la propria regione."
...
## Privacy e controllo dei dati: da adempimento a leva di fiducia {#privacy-e-controllo-dei-dati}
