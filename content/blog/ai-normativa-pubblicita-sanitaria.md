...
og_image: "img/blog/ai-normativa-pubblicita-sanitaria-og.jpg"
image_alt: "Normativa della pubblicità sanitaria: cosa una struttura privata può pubblicare"
tags: ["normativa", "strategia"]
servizio: "advertising-sanitario"
sources: "Legge 145/2018, art. 1, comma 525, come modificato dall'art. 6 del D.L. 69/2023 convertito con modificazioni dalla Legge 103/2023. Decreto Bersani (D.L. 223/2006), liberalizzazione della pubblicità informativa. Codice di Deontologia Medica FNOMCeO, artt. 55-57. Tribunale di Siracusa, Seconda Sezione Civile, sentenza n. 338/2026 depositata il 20 febbraio 2026 (responsabilità aggravata ex art. 96 c.p.c. per uso non verificato dell'AI). Regolamento UE 2024/1689 (AI Act) e Legge 23 settembre 2025, n. 132 (disposizioni in materia di intelligenza artificiale). Caso UE NIF 2020/4008."
faqs:
  - q: "Posso chiedere a ChatGPT o a un'altra AI cosa può pubblicare il mio studio?"
    a: "Puoi usarla come punto di partenza, ma non come fonte. I modelli generativi producono sequenze linguistiche plausibili, non verificate: in un nostro test un'AI ha citato una inesistente 'Legge Boldi' come norma della pubblicità sanitaria. Su un tema in cui la responsabilità ricade sul professionista e sul direttore sanitario, la risposta va sempre verificata sul testo di legge vigente da chi ha la competenza per farlo."
  - q: "Qual è la norma vigente sulla pubblicità sanitaria?"
    a: "L'art. 1, comma 525, della Legge 145/2018, come modificato dall'art. 6 del D.L. 69/2023 convertito nella Legge 103/2023. Ammette esclusivamente le informazioni funzionali a garantire una corretta informazione sanitaria ed esclude qualsiasi elemento attrattivo e suggestivo, tra cui la legge nomina espressamente offerte, sconti e promozioni, idoneo a determinare un ricorso improprio alle prestazioni. Il precedente riferimento alla sicurezza dei trattamenti è stato superato."
  - q: "Testimonial, immagini del prima e dopo e influencer sono vietati dalla legge?"
    a: "Non sono nominati dal testo di legge, che cita espressamente solo offerte, sconti e promozioni. Sono le linee guida degli Ordini e della FNOMCeO a ricondurli al divieto di comunicazione attrattiva e suggestiva, valutati caso per caso. È una distinzione operativa: confondere ciò che dice la legge con l'interpretazione degli Ordini porta a errori nella comunicazione."
  - q: "Le recensioni dei pazienti si possono usare?"
    a: "La recensione autentica resta utilizzabile se veritiera, non concordata né incentivata, e con il consenso scritto richiesto dalla normativa privacy. Non è la stessa cosa di un testimonial costruito: la prima è informazione, il secondo è un messaggio suggestivo."
  - q: "Se la comunicazione la produce un'agenzia, di chi è la responsabilità?"
    a: "Resta del professionista e del direttore sanitario della struttura, anche quando il contenuto è prodotto da terzi. Per questo la conformità non è un adempimento accessorio, ma una condizione del lavoro: un'agenzia che opera in sanità deve conoscere il testo vigente e la sua interpretazione, non affidarsi a una fonte non verificata."
draft: false
---
...
Le regole generali di come si comunica in questo settore restano quelle della [guida al marketing sanitario](/marketing-sanitario/). Qui affrontiamo un punto più specifico: perché non si può delegare a un'AI la lettura della norma, e cosa dice davvero il testo vigente.

---

1. [Perché un'AI inventa una norma](#perche-unai-inventa-una-norma)
2. [Il rischio non è teorico: la giurisprudenza](#il-rischio-non-e-teorico-la-giurisprudenza)
3. [Cosa dice davvero la normativa vigente](#cosa-dice-davvero-la-normativa-vigente)
4. [Ciò che la legge non dice](#cio-che-la-legge-non-dice)
5. [La verifica è una competenza, non un automatismo](#la-verifica-e-una-competenza-non-un-automatismo)
6. [FAQ](#faq)
...
Il Codice di Deontologia Medica della FNOMCeO (artt. 55-57) fissa il principio generale, ossia che l'informazione sanitaria non può essere promozionale né suggestiva. Il confine, come abbiamo già descritto parlando di [comunicazione sanitaria](/blog/comunicazione-sanitaria/), non è tra ciò che si può dire e ciò che si deve tacere, ma tra informare e reclamizzare.
